...
// const [programItems, setProgramItems] = useState<Program[]>([]);
...
// 🔥 Map icon string from Firestore → actual component
...
export default function ProgramScheduleSection() {
  ...
  return (
    <section
      id="programs"
      className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden"
    >
      {/* Animated background elements */}
      <div className="absolute inset-0 opacity-40">
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join us for our regular spiritual discourses, educational classes,
              ...
              <div key={item.id} className="group relative">
                ...
                <div className="relative bg-gradient-to-br from-slate-800 to-slate-800/50 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-slate-700/50 group-hover:border-slate-600 transition-all duration-200 h-full group-hover:translate-y-[-2px]">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`bg-gradient-to-br ${item.color} p-3 rounded-xl shadow-lg transition-all duration-200`}
                      >
                      ...
                      {/* Time Badge */}
                      <div
                        className={`${item.lightColor} text-sm font-bold px-3 py-1.5 rounded-full border border-slate-600/50 transition-all duration-200 backdrop-blur-sm`}
                      >
                        <span
