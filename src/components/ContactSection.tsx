...
export default function ContactSection() {
  ...
  // 🔥 REPLACED STATIC VARIABLES WITH FIREBASE DATA
  const MAPS_URL = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(
    contactDetails.address
  )}`;

  const PHONE_HREF = contactDetails.phone
            ...
            <div className="space-y-6">
              ...
              {contactDetails.address && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-white mb-2 text-lg">Location</h4>
              ...
              {contactDetails.email && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-white mb-2 text-lg">General Inquiry</h4>
