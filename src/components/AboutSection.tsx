      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* 1. Spiritual Center */}
            <div className="group relative">
              <div className="relative flex items-start p-6 sm:p-8 bg-gradient-to-br from-slate-800/60 to-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/50 group-hover:border-blue-500/30 transition-all duration-300">
                <div className="flex-shrink-0 mr-5">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-blue-500/30 transition-all duration-300 transform group-hover:scale-105">
                    <Landmark size={32} className="text-white" />
                  </div>
                </div>
                <div className="flex-1">
            ...
            {/* 2. Educational Hub */}
            <div className="group relative">
              <div className="relative flex items-start p-6 sm:p-8 bg-gradient-to-br from-slate-800/60 to-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/50 group-hover:border-emerald-500/30 transition-all duration-300">
                <div className="flex-shrink-0 mr-5">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-emerald-500/30 transition-all duration-300 transform group-hover:scale-105">
                    <BookOpen size={32} className="text-white" />
                  </div>
                </div>
                <div className="flex-1">
            ...
            {/* 3. Community Engagement */}
            <div className="group relative">
              <div className="relative flex items-start p-6 sm:p-8 bg-gradient-to-br from-slate-800/60 to-slate-800/30 backdrop-blur-xl rounded-2xl border border-slate-700/50 group-hover:border-purple-500/30 transition-all duration-300">
                <div className="flex-shrink-0 mr-5">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-purple-500/30 transition-all duration-300 transform group-hover:scale-105">
                    <Handshake size={32} className="text-white" />
                  </div>
                </div>
                <div className="flex-1">
